...
import { PrintAction } from '../utils/sequential-actions';
...
const LoginPanel: FC = () => {
    ...
    return (
        <Panel id="LoginPanel" visible={visible} className="NormalPanel" style={{ zIndex: 1000 }} onactivate={toggleShow}>
            <Panel visible={errorVisible} className="NormalPanel" style={{ zIndex: 100, width: `100%`, height: `100%` }}>
                <Label
                    text={'加载失败'}
                    style={{
                        fontSize: '48px',
